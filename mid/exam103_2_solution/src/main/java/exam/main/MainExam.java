...
import static exam.base.ToBeEnum.FRESHMAN;
import static exam.base.ToBeEnum.JUNIOR;
import static exam.base.ToBeEnum.SENIOR;
import static exam.base.ToBeEnum.SOPHOMORE;
...
public class MainExam {
    ...
    private static final ToCompare[] cmps = { new ToCompare(010, "65130500010"),
    ...
    private static void exam03ToIterate() {
        ...
        for (var i = dataSet.iterator(); i.hasNext(); ) {
            System.out.println(i.next());
        }
        for (ToCompare toCompare : dataSet) {
